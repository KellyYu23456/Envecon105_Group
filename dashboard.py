...
with tab3:
    ...
    # --- coerce Year to integer and drop bad rows
    ...
    # --- compute overlap with the selected range
    ...
    # Scaled scatter (only if we truly have overlap)
    ...
    if len(common_years) < 3:
        ...
        if len(merged) >= 3:
            ...
            # regression line (numpy, no statsmodels dependency)
